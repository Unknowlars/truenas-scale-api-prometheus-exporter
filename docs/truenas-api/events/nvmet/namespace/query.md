...
kind: event
source_rst: _sources/api_events_nvmet.namespace.query.rst.txt
source_html: api_events_nvmet.namespace.query.html
required_roles:
...
- Schema name: `NVMetNamespaceAddedEvent`
- Type: object
...
- Schema name: `NVMetNamespaceChangedEvent`
- Type: object
- No Additional Properties
#### id (required)
...
- Schema name: `NVMetNamespaceRemovedEvent`
- Type: object
- No Additional Properties
#### id (required)
