---
title: iscsi.extent.query
kind: event
source_rst: _sources/api_events_iscsi.extent.query.rst.txt
source_html: api_events_iscsi.extent.query.html
required_roles:
...
- Schema name: `IscsiExtentAddedEvent`
- Type: object
...
- Schema name: `IscsiExtentChangedEvent`
- Type: object
- No Additional Properties
#### id (required)
...
- Schema name: `IscsiExtentRemovedEvent`
- Type: object
- No Additional Properties
#### id (required)
