---
title: sharing.smb.query
kind: event
source_rst: _sources/api_events_sharing.smb.query.rst.txt
source_html: api_events_sharing.smb.query.html
required_roles:
  - SHARING_SMB_READ
---
...
- Schema name: `SmbShareAddedEvent`
- Type: object
...
- Schema name: `SmbShareChangedEvent`
- Type: object
- No Additional Properties
#### id (required)
...
- Schema name: `SmbShareRemovedEvent`
- Type: object
- No Additional Properties
#### id (required)
