...
title: user.query
kind: event
source_rst: _sources/api_events_user.query.rst.txt
source_html: api_events_user.query.html
required_roles:
  - ACCOUNT_READ
---
