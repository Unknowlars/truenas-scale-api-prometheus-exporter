...
kind: event
source_rst: _sources/api_events_cloudsync.query.rst.txt
source_html: api_events_cloudsync.query.html
required_roles:
  - CLOUD_SYNC_READ
---
...
- Schema name: `CloudSyncAddedEvent`
- Type: object
...
- Schema name: `CloudSyncChangedEvent`
- Type: object
- No Additional Properties
#### id (required)
...
- Schema name: `CloudSyncRemovedEvent`
- Type: object
- No Additional Properties
#### id (required)
