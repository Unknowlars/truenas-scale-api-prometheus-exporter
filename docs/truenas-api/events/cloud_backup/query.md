---
title: cloud_backup.query
kind: event
source_rst: _sources/api_events_cloud_backup.query.rst.txt
source_html: api_events_cloud_backup.query.html
required_roles:
  - CLOUD_BACKUP_READ
---
...
- Schema name: `CloudBackupAddedEvent`
- Type: object
...
- Schema name: `CloudBackupChangedEvent`
- Type: object
- No Additional Properties
#### id (required)
...
- Schema name: `CloudBackupRemovedEvent`
- Type: object
- No Additional Properties
#### id (required)
