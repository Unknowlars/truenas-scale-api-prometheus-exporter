...
kind: method
source_rst: _sources/api_methods_sharing.smb.query.rst.txt
source_html: api_methods_sharing.smb.query.html
required_roles:
  - SHARING_SMB_READ
---
...
###### SmbShareQueryResultItem

- Schema name: `SmbShareQueryResultItem`
- Type: object
- No Additional Properties
####### id
