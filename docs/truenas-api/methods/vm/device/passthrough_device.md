---
title: vm.device.passthrough_device
kind: method
source_rst: _sources/api_methods_vm.device.passthrough_device.rst.txt
source_html: api_methods_vm.device.passthrough_device.html
required_roles:
  - VM_DEVICE_READ
---
