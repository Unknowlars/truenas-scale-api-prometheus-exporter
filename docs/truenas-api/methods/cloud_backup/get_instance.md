---
title: cloud_backup.get_instance
kind: method
source_rst: _sources/api_methods_cloud_backup.get_instance.rst.txt
source_html: api_methods_cloud_backup.get_instance.html
required_roles:
  - CLOUD_BACKUP_READ
---
