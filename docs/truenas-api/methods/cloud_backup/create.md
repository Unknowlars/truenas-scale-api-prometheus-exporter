---
title: cloud_backup.create
kind: method
source_rst: _sources/api_methods_cloud_backup.create.rst.txt
source_html: api_methods_cloud_backup.create.html
required_roles:
  - CLOUD_BACKUP_WRITE
---
...
#### Parameter 1: cloud_backup

#### cloud_backup

- Schema name: `cloud_backup`
- Type: object
