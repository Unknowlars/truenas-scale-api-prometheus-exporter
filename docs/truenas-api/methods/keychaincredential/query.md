...
kind: method
source_rst: _sources/api_methods_keychaincredential.query.rst.txt
source_html: api_methods_keychaincredential.query.html
required_roles:
...
- Schema name: `KeychainCredentialQueryResultItem`
- Type: object
- No Additional Properties
####### id
