---
title: virt.device.import_disk_image
kind: method
source_rst: _sources/api_methods_virt.device.import_disk_image.rst.txt
source_html: api_methods_virt.device.import_disk_image.html
required_roles:
  - VIRT_INSTANCE_WRITE
---
...
- Schema name: `virt_device_import_disk_image`
- Type: object

VirtDeviceImportDiskImageArgs parameters.
