...
title: audit.query
kind: method
source_rst: _sources/api_methods_audit.query.rst.txt
source_html: api_methods_audit.query.html
required_roles:
  - SYSTEM_AUDIT_READ
---
...
- Schema name: `AuditQueryResultItem`
- Type: object
###### audit_id

- Schema name: `Audit Id`
