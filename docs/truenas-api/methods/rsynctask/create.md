---
title: rsynctask.create
kind: method
source_rst: _sources/api_methods_rsynctask.create.rst.txt
source_html: api_methods_rsynctask.create.html
required_roles:
  - SNAPSHOT_TASK_WRITE
---
...
#### Parameter 1: rsync_task_create

#### rsync_task_create

- Schema name: `rsync_task_create`
- Type: object
