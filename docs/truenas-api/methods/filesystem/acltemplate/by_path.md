---
title: filesystem.acltemplate.by_path
kind: method
source_rst: _sources/api_methods_filesystem.acltemplate.by_path.rst.txt
source_html: api_methods_filesystem.acltemplate.by_path.html
required_roles:
...
- Schema name: `AclTemplateFormatOptions`
- Type: object
- Default:
```json
{
