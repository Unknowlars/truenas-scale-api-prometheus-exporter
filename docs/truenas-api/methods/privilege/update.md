...
kind: method
source_rst: _sources/api_methods_privilege.update.rst.txt
source_html: api_methods_privilege.update.html
required_roles:
  - PRIVILEGE_WRITE
---
...
#### Parameter 2: privilege_update

#### privilege_update

- Schema name: `privilege_update`
- Type: object
