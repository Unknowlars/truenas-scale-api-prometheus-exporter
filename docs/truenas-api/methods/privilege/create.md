---
title: privilege.create
kind: method
source_rst: _sources/api_methods_privilege.create.rst.txt
source_html: api_methods_privilege.create.html
required_roles:
  - PRIVILEGE_WRITE
---
