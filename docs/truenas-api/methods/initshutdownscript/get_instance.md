---
title: initshutdownscript.get_instance
kind: method
source_rst: _sources/api_methods_initshutdownscript.get_instance.rst.txt
source_html: api_methods_initshutdownscript.get_instance.html
required_roles:
  - SYSTEM_CRON_READ
---
