...
kind: method
source_rst: _sources/api_methods_kerberos.keytab.query.rst.txt
source_html: api_methods_kerberos.keytab.query.html
required_roles:
...
- Schema name: `KerberosKeytabQueryResultItem`
- Type: object
- No Additional Properties
####### id
