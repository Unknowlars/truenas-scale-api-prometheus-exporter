...
kind: method
source_rst: _sources/api_methods_iscsi.targetextent.query.rst.txt
source_html: api_methods_iscsi.targetextent.query.html
required_roles:
...
- Schema name: `IscsiTargetToExtentQueryResultItem`
- Type: object
- No Additional Properties
####### id
