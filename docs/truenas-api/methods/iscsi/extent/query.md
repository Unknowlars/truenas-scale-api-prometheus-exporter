...
kind: method
source_rst: _sources/api_methods_iscsi.extent.query.rst.txt
source_html: api_methods_iscsi.extent.query.html
required_roles:
...
###### IscsiExtentQueryResultItem

- Schema name: `IscsiExtentQueryResultItem`
- Type: object
- No Additional Properties
####### id
