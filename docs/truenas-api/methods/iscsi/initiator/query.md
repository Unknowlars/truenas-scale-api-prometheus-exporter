...
kind: method
source_rst: _sources/api_methods_iscsi.initiator.query.rst.txt
source_html: api_methods_iscsi.initiator.query.html
required_roles:
...
###### IscsiInitiatorQueryResultItem

- Schema name: `IscsiInitiatorQueryResultItem`
- Type: object
- No Additional Properties
####### id
