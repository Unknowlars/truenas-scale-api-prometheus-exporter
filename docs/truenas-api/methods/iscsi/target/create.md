---
title: iscsi.target.create
kind: method
source_rst: _sources/api_methods_iscsi.target.create.rst.txt
source_html: api_methods_iscsi.target.create.html
required_roles:
...
- Schema name: `iscsi_target_create`
- Type: object
