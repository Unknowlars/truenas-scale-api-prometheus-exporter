---
title: iscsi.target.update
kind: method
source_rst: _sources/api_methods_iscsi.target.update.rst.txt
source_html: api_methods_iscsi.target.update.html
required_roles:
...
- Schema name: `iscsi_target_update`
- Type: object
