---
title: boot.environment.clone
kind: method
source_rst: _sources/api_methods_boot.environment.clone.rst.txt
source_html: api_methods_boot.environment.clone.html
required_roles:
  - BOOT_ENV_WRITE
---
...
- Schema name: `boot_environment_clone`
- Type: object

BootEnvironmentCloneArgs parameters.
