---
title: boot.environment.activate
kind: method
source_rst: _sources/api_methods_boot.environment.activate.rst.txt
source_html: api_methods_boot.environment.activate.html
required_roles:
  - BOOT_ENV_WRITE
---
...
- Schema name: `boot_environment_activate`
- Type: object
