---
title: cloudsync.create
kind: method
source_rst: _sources/api_methods_cloudsync.create.rst.txt
source_html: api_methods_cloudsync.create.html
required_roles:
  - CLOUD_SYNC_WRITE
---
