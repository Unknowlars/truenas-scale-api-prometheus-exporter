---
title: pool.dataset.get_quota
kind: method
source_rst: _sources/api_methods_pool.dataset.get_quota.rst.txt
source_html: api_methods_pool.dataset.get_quota.html
required_roles:
  - DATASET_READ
---
