---
title: pool.snapshot.get_instance
kind: method
source_rst: _sources/api_methods_pool.snapshot.get_instance.rst.txt
source_html: api_methods_pool.snapshot.get_instance.html
required_roles:
  - SNAPSHOT_READ
---
