---
title: directoryservices.update
kind: method
source_rst: _sources/api_methods_directoryservices.update.rst.txt
source_html: api_methods_directoryservices.update.html
required_roles:
...
- Schema name: `directoryservices_update`
- Type: object

DirectoryServicesUpdateArgs parameters.
