---
title: nvmet.port_subsys.update
kind: method
source_rst: _sources/api_methods_nvmet.port_subsys.update.rst.txt
source_html: api_methods_nvmet.port_subsys.update.html
required_roles:
...
- Schema name: `nvmet_port_subsys_update`
- Type: object
