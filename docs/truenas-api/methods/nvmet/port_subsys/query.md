...
kind: method
source_rst: _sources/api_methods_nvmet.port_subsys.query.rst.txt
source_html: api_methods_nvmet.port_subsys.query.html
required_roles:
...
- Schema name: `NVMetPortSubsysQueryResultItem`
- Type: object
- No Additional Properties
####### id
