---
title: nvmet.host_subsys.create
kind: method
source_rst: _sources/api_methods_nvmet.host_subsys.create.rst.txt
source_html: api_methods_nvmet.host_subsys.create.html
required_roles:
...
- Schema name: `nvmet_host_subsys_create`
- Type: object
