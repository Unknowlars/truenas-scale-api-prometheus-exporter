...
kind: method
source_rst: _sources/api_methods_nvmet.host_subsys.query.rst.txt
source_html: api_methods_nvmet.host_subsys.query.html
required_roles:
...
- Schema name: `NVMetHostSubsysQueryResultItem`
- Type: object
- No Additional Properties
####### id
