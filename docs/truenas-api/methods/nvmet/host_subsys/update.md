---
title: nvmet.host_subsys.update
kind: method
source_rst: _sources/api_methods_nvmet.host_subsys.update.rst.txt
source_html: api_methods_nvmet.host_subsys.update.html
required_roles:
...
- Schema name: `nvmet_host_subsys_update`
- Type: object
