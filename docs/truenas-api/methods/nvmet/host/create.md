---
title: nvmet.host.create
kind: method
source_rst: _sources/api_methods_nvmet.host.create.rst.txt
source_html: api_methods_nvmet.host.create.html
required_roles:
...
#### Parameter 1: nvmet_host_create

#### nvmet_host_create

- Schema name: `nvmet_host_create`
- Type: object
