---
title: nvmet.namespace.create
kind: method
source_rst: _sources/api_methods_nvmet.namespace.create.rst.txt
source_html: api_methods_nvmet.namespace.create.html
required_roles:
...
- Schema name: `nvmet_namespace_create`
- Type: object
